...
- A stubbed dependency hides integration bugs: keep at least one test per user-facing path that runs the real thing end to end (run_update + real build_report caught run_date='results_<date>' breaking the report).
